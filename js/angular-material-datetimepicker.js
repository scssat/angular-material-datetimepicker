(function (moment) {
  ...
  var template = '<md-dialog class="dtp" layout="column" style="width: 300px;">'
      ...
      + '                     <div layout="row">'
      + '                       <div ng-click="picker.incrementMonth(-1)" class="dtp-year-btn dtp-year-btn-prev" flex="30"><span ng-if="picker.isPreviousMonthVisible()" >&#x25B2;</span></div>'
      + '                       <div class="dtp-actual-month" flex>{{picker.currentDate.format("MMM") | uppercase}}</div>'
      + '                       <div ng-click="picker.incrementMonth(1)" class="dtp-year-btn dtp-year-btn-next" flex="30"><span ng-if="picker.isNextMonthVisible()" >&#x25BC;</span></div></div>'
      ...
      + '            </div>'
      + '            <div class="dtp-picker" ng-if="!picker.params.monthPicker">'
